...
struct FHighLightMaterialInfo
{
	...
	UMaterialInterface* HoveredMaterial = LoadObject<UMaterialInterface>(
		nullptr,
		TEXT("MaterialInstanceConstant'/MetaLandRoad/Material/HoveredHighLightMaterial_Inst.HoveredHighLightMaterial_Inst'"));

	UPROPERTY()
	UMaterialInterface* SelectedMaterial = LoadObject<UMaterialInterface>(
		nullptr,
		TEXT("MaterialInstanceConstant'/MetaLandRoad/Material/SelectedHighLightMaterial_Inst.SelectedHighLightMaterial_Inst'"));
};



UCLASS()
class METALANDROAD_API UShapesGenerationToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
UCLASS()
class METALANDROAD_API UShapesGenerationTool : public UInteractiveTool, public IHoverBehaviorTarget, public IClickDragBehaviorTarget, public IMouseWheelBehaviorTarget
{
	GENERATED_BODY()

...
#include "FloodComponent2D.generated.h"
...
class UFloodComponent2D : public UActorComponent
{
public:
	GENERATED_BODY()

	UFloodComponent2D(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

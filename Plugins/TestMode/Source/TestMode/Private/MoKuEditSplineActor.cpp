...
void AMoKuEditSplineActor::SetSplineComponent(UMoKuEditSplinesComponent* InSplineComponent)
{
	...
	if (FLevelEditorModule* LevelEditorModule = FModuleManager::GetModulePtr<FLevelEditorModule>(TEXT("LevelEditor")))
	{
		...
		if (LevelEditorPtr.IsValid())
		{
			...
			UTestModeInteractiveTool* CurTool = Cast<UTestModeInteractiveTool>(EditMode->GetToolManager()->GetActiveTool(EToolSide::Left));
...
//{
//	UTestModeEditorMode* CurrentEditMode = MoKuSplineEditorUtils::GetCurrentEditMode<UTestModeEditorMode>(UTestModeEditorMode::EM_TestModeEditorModeId);
//
//	if (CurrentEditMode)
//	{
	 ...
	 if (PropertyThatChanged != nullptr)
	 {
		 ...
		 else if (bIsDragging&&PropertyChangedEvent.ChangeType!=EPropertyChangeType::Interactive||PropertyChangedEvent.ChangeType == EPropertyChangeType::ValueSet)
		 {
			 ...
			 if (Category != TEXT("ExtraMesh"))
			 {
				...
				if (CurrentEditMode)
				{
					UTestModeInteractiveTool* CurTool = Cast<UTestModeInteractiveTool>(CurrentEditMode->GetToolManager()->GetActiveTool(EToolSide::Left));
					TMap<TObjectPtr<AMoKuEditBaseActor>, TArray<FSocketGizmoTransformInfo>> GizmoInfo;

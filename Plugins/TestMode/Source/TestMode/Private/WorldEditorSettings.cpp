...
UWorldEditorSettings::UWorldEditorSettings()
	...
	, LandscapeMaterialParameterCollection(FSoftObjectPath(TEXT("/TestMode/Landscape/BlueprintBrushes/MPC/MPC_Landscape.MPC_Landscape")))
	, WorldEditorManagerClassPath("/Script/TestMode.WorldLandscapeBlueprintBrush")
	, DefaultBrushAngleFalloffMaterial(FSoftObjectPath(TEXT("/TestMode/Material/Landscape/LandmassBrush_Blender.LandmassBrush_Blender")))
	, DefaultBrushWidthFalloffMaterial(FSoftObjectPath(TEXT("/Water/Materials/Brushes/MeshBrush_Width.MeshBrush_Width")))
	, DefaultBrushWeightmapMaterial(FSoftObjectPath(TEXT("/TestMode/Material/Landscape/Brush/RoadMeshBrush_Weightmap.RoadMeshBrush_Weightmap")))
	, DefaultCacheDistanceFieldCacheMaterial(FSoftObjectPath(TEXT("TestMode/Material/Landscape/CacheDistanceField.CacheDistanceField")))
	, DefaultCompositeRoadBodyTextureMaterial(FSoftObjectPath(TEXT("TestMode/Material/Landscape/Brush/CompositeMeshBodyTexture.CompositeMeshBodyTexture")))
	...
	, DefaultRenderRoadSplineDepthsMaterial(FSoftObjectPath(TEXT("/TestMode/Material/Landscape/RenderMeshDepths.RenderMeshDepths")))
	//, DefaultRenderRoadSplineDepthsMaterial(FSoftObjectPath(TEXT("/TestMode/Material/Landscape/RenderMeshDepths.RenderMeshDepths")))
{

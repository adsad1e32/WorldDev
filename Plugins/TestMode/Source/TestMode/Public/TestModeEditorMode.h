...
#include "TestModeEditorMode.generated.h"

#define SPLINETOOLNAME "TestMode_SplineTool"
#define SHAPESTOOLNAME "TestMode_ShapesGenerationTool"
...
UCLASS(Transient)
class UTestModeEditorMode : public UBaseLegacyWidgetEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_TestModeEditorModeId;
	...
	UTestModeEditorMode(FVTableHelper& Helper);
	UTestModeEditorMode();
	virtual ~UTestModeEditorMode();
